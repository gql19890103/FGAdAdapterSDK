...
Pod::Spec.new do |spec|
  ...
  # 使用GitHub仓库 https://gitee.com/guan-dalong/fgad-adapter-sdk/raw/1.0.0/FGAdAdapterSDK.zip
    spec.source = { :http => "https://gitee.com/guan-dalong/fgad-adapter-sdk/raw/1.4.0/FGAdAdapterSDK.zip" }
  ...
  # spec.resources = "FGAdAdapterSDK.xcframework/**/*.bundle"
  # spec.resources = ['FGAdAdapterSDK/SYAd.bundle/**/*']
  ...
  spec.dependency 'TimeAdSDK', '1.5.5'
